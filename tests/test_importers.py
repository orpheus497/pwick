...
from pwick.importers.csv_importer import ImportResult, detect_csv_format, import_from_csv
from pwick.importers.keepass_importer import import_from_keepass_csv
from pwick.importers.bitwarden_importer import import_from_bitwarden_json, import_from_bitwarden_csv
...
class TestCSVFormatDetection:
    ...
    def test_detect_bitwarden_format(self, tmp_path):
        ...
        csv_file.write_text("folder,favorite,type,name,notes,fields,login_uri,login_username,login_password,login_totp\n"
    ...
    def test_detect_lastpass_format(self, tmp_path):
        ...
        csv_file.write_text("url,username,password,extra,name,grouping,fav\n"
    ...
    def test_detect_onepassword_format(self, tmp_path):
        ...
        csv_file.write_text("Title,Website,Username,Password,Notes,Type\n"
...
class TestKeePassImporter:
    ...
    def test_import_keepass_csv(self, tmp_path):
        ...
        def mock_add_entry(vault_obj, title, username, password, notes, tags, entry_type):
            entry_counter[0] += 1
...
class TestGenericCSVImporter:
    ...
    def test_import_generic_csv_with_mapping(self, tmp_path):
        ...
        csv_file.write_text("site,user,pass,comment\n"
